...
function UniverseSection() {
	return (
		<div className="flex flex-col gap-7 items-center text-center px-5 sm:px-8 py-8  bg-purple-950">
			<Title title="Open the door to a new universe" color="text-white" />
			<About
				title="Atrox combines strategy, product, design and engineering to build 
