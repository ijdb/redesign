	...
	return (
		<form onSubmit={handleSubmit} className="max-w-md mx-auto p-4">
			...
			<div className="mb-5">
				...
				<div className="flex">
					<div className="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-900 bg-gray-100 border border-gray-300 rounded-l-lg">
						🇮🇳 IN +91
					</div>
					<input
						type="tel"
						...
						onChange={handleChange}
						className="rounded-none rounded-r-lg border text-gray-900 block flex-1 min-w-0 w-full text-sm p-2.5"
					/>
				</div>
			</div>
